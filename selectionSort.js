...
//Time complexity of Selection Sort is O(n2), as we loop over 2 times,
//Space complexity of Selection Sort is O(n), 
//as we dont use Extra space for any operation except Swap which max take n Swap. 
...
selectionSort([21,34,1,4,34,87,3]);

//======================Sort an array of String using Selection Sort===================
//Question :- Sort an Array of String by Selection sort
selectionSort
([
  'hello',
  'mery',
